...
class ApiService {
  ...
  Future<dynamic> fetchAllNews(String category) async {
    String newsUrl =
        'https://newsapi.org/v2/everything?q=$category&apiKey=8a5ec37e26f845dcb4c2b78463734448';
    final response = await http.get(Uri.parse(newsUrl));
    debugPrint("FAHAMIN"+response.body.toString());
    return returnResponse(response);
  }

  Future<dynamic> fetchNewsChannelHeadlinesApi(String newsChannel) async {
    String newsUrl =
